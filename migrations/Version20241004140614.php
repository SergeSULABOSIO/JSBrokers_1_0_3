 ...
 */
final class Version20241004140614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invite_entreprise (invite_id INT NOT NULL, entreprise_id INT NOT NULL, INDEX IDX_B3B918BEA417747 (invite_id), INDEX IDX_B3B918BA4AEAFEA (entreprise_id), PRIMARY KEY(invite_id, entreprise_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
