 ...
 */
final class Version20260315063024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE taxe DROP entreprise_id, DROP code, DROP redevable');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE taxe ADD entreprise_id INT DEFAULT NULL, ADD code VARCHAR(5) NOT NULL, ADD redevable INT NOT NULL');
