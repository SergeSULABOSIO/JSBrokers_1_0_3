 ...
 */
final class Version20250208102601 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article_type_revenu (article_id INT NOT NULL, type_revenu_id INT NOT NULL, INDEX IDX_C4F7C11A7294869C (article_id), INDEX IDX_C4F7C11A20F3EE6A (type_revenu_id), PRIMARY KEY(article_id, type_revenu_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
