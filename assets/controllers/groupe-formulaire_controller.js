...
export default class extends Controller {
    ...
    connect() {
        this.isSaved = false;
        // console.log("ID GROUPE: " + this.idgroupeValue);
    ...
    /**
     * 
     * @param {Number} nbClients 
     */
    initBadges(nbClients) {
        this.displayclientTarget.innerHTML = "";

        // Clients
        if (nbClients != 0) {
            this.displayclientTarget.append(this.generateSpanElement(nbClients));
        }
    }
