...
export default class extends Controller {
    ...
    connect() {
        ...
        this.modecalculTarget.addEventListener("change", event => this.changerModeCalcul(event));
     ...
     */
    appliquerModeCalcul(selectedValue) {
        if (selectedValue == 0) {
            this.block_pourcentageTarget.style.display = 'inline';
            this.block_flatTarget.style.display = 'none';
        } else {
            this.block_pourcentageTarget.style.display = 'none';
            this.block_flatTarget.style.display = 'inline';
        }
    }
