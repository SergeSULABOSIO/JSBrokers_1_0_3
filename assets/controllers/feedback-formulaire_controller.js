...
export default class extends Controller {
    ...
    connect() {
        ...
        if (this.hasnextactionTarget.value == undefined) {
            this.hasnextactionTarget.value = "0";
        }
        this.setChampsActionComplementaire(this.hasnextactionTarget.value);
    }
    ...
    */
    enregistrer = (event) => {
        ...
        this.isSaved = true;
        this.displayTarget.textContent = "Enregistrement de " + this.descriptionTarget.value + " en cours...";
    ...
    setChampsActionComplementaire = (selectedValue) => {
        switch (selectedValue) {
            case "1"://Oui, avec action prochaine
                this.nextactionTarget.style.display = 'block';
                break;
            case "0"://Non, sans action prochaine 
                this.nextactionTarget.style.display = 'none';
                break;
