...
class AssistantIaWorkspaceTest extends WebTestCase
{
    ...
    public function testChatRendLeBoutonDicteeVocale(): void
    {
        ...
        // Infobulle sombre Joseara (pas le title natif) : copie posée en data-*.
    ...
    {
        // Procédure « l'utilisateur remplit lui-même » : ouvrir_dialogue reste
        // disponible pour Client et remonte la directive open-dialog au chat.
        ['guest' => $guest, 'entreprise' => $e] = $this->seed(
            withClientRole: true,
