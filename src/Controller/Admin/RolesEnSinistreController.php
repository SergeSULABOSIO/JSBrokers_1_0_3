...
#[Route("/admin/rolesensinistre", name: 'admin.rolesensinistre.')]
#[IsGranted('ROLE_USER')]
class RolesEnSinistreController extends AbstractController
{
    ...
    public function getFormApi(?RolesEnSinistre $role, Request $request): Response
    {
        return $this->renderFormCanvas(
            $request,
            RolesEnSinistre::class,
            RolesEnSinistreType::class,
            $role,
            function (RolesEnSinistre $role, Invite $connectedInvite) use ($request) {
                ...
                $role->setNom("Droits d'accès dans le module Sinistre");
            }
        );
    }
    ...
    public function deleteApi(RolesEnSinistre $role): Response
    {
