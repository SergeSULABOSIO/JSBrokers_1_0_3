...
class TrancheController extends AbstractController
{
    ...
    #[Route('/getstatuspanier/{idTranche}/{idEntreprise}', name: 'getstatuspanier', requirements: [
        'idTranche' => Requirement::DIGITS,
        'idEntreprise' => Requirement::DIGITS,
    ])]
    public function getstatuspanier(int $idTranche, int $idEntreprise, Request $request)
    {
        /** @var Tranche $tranche */
        $tranche = $this->trancheRepository->find($idTranche);
