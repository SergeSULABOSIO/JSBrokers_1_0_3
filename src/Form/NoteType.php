...
class NoteType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        // dd($options['page']);
        if ($options['type'] == -1) {
            $this->pageA($builder, $options);
        } else {    
            // dd("Candidat à la page B!");
            $this->pageB($builder, $options);
        }
    }


    public function pageB(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('articles', CollectionType::class, [
                'label' => "Articles",
    ...
    public function pageA(FormBuilderInterface $builder, array $options): void
    {
        $builder
