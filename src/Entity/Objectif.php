...
class Objectif
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Document::class, mappedBy: 'objectif', cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    public function removeDocument(Document $document): static
    {
        if ($this->documents->removeElement($document)) {
            ...
            if ($document->getObjectif() === $this) {
                $document->setObjectif(null);
            }
        }
