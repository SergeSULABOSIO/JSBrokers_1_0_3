...
class Charge
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Document::class, mappedBy: 'charge', cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    public function removeDocument(Document $document): static
    {
        if ($this->documents->removeElement($document)) {
            ...
            if ($document->getCharge() === $this) {
                $document->setCharge(null);
            }
        }
