...
class Assureur
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Document::class, mappedBy: 'assureur', cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    public function removeDocument(Document $document): static
    {
        if ($this->documents->removeElement($document)) {
            ...
            if ($document->getAssureur() === $this) {
                $document->setAssureur(null);
            }
        }
