...
class Top20ClientReportSet
{
    ...
    /**
     * Get the value of other_loadings
     */ 
    public function getOther_loadings()
    {
        return $this->other_loadings;
    }

    /**
     * Set the value of other_loadings
     *
     * @return  self
     */ 
    public function setOther_loadings($other_loadings)
    {
        $this->other_loadings = $other_loadings;

        return $this;
    }

    /**
     * Get the value of net_premium
     */ 
    public function getNet_premium()
    {
        return $this->net_premium;
    }

    /**
     * Set the value of net_premium
     *
     * @return  self
     */ 
    public function setNet_premium($net_premium)
    {
