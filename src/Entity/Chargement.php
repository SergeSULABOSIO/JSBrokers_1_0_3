...
/**
 * ⚠ UN TYPE DE CHARGEMENT N'EXISTE QU'UNE FOIS PAR CABINET.
 *
...
#[ORM\UniqueConstraint(name: 'uniq_chargement_entreprise_cle', columns: ['entreprise_id', 'nom'])]
class Chargement
{
    use AuditableTrait;
     ...
     */
    #[ORM\OneToMany(targetEntity: Document::class, mappedBy: 'chargement', cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    public function removeDocument(Document $document): static
    {
        if ($this->documents->removeElement($document)) {
            ...
            if ($document->getChargement() === $this) {
                $document->setChargement(null);
            }
        }
