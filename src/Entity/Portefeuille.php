...
class Portefeuille
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Document::class, mappedBy: 'portefeuille', cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    public function removeDocument(Document $document): static
    {
        if ($this->documents->removeElement($document)) {
            ...
            if ($document->getPortefeuille() === $this) {
                $document->setPortefeuille(null);
            }
        }
