...
class Entreprise
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Document::class, mappedBy: 'entrepriseRattachee', cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    public function addDocument(Document $document): static
    {
        if (!$this->documents->contains($document)) {
            ...
            $document->setEntrepriseRattachee($this);
        }
    ...
    public function removeDocument(Document $document): static
    {
        if ($this->documents->removeElement($document)) {
            ...
            if ($document->getEntrepriseRattachee() === $this) {
                $document->setEntrepriseRattachee(null);
            }
        }
