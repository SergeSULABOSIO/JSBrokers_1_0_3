...
class DepenseCourtier
{
     ...
     */
    #[ORM\OneToMany(targetEntity: Document::class, mappedBy: 'depenseCourtier', cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    public function addDocument(Document $document): static
    {
        if (!$this->documents->contains($document)) {
            ...
            $document->setDepenseCourtier($this);
        }
    ...
    public function removeDocument(Document $document): static
    {
        if ($this->documents->removeElement($document)) {
            ...
            if ($document->getDepenseCourtier() === $this) {
                $document->setDepenseCourtier(null);
            }
        }
