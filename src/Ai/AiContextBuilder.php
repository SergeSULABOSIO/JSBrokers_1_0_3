...
class AiContextBuilder
{
    ...
    private function sectionPiecesJointes(array $fichiers): string
    {
        ...
        return "\nPIÈCES JOINTES — l'utilisateur a ATTACHÉ le(s) fichier(s) ci-dessous à cette conversation."
            ...
            . "TOUTE fiche de la plateforme porte une collection « Documents » : ne réponds JAMAIS qu'un "
            . "enregistrement n'accepte pas de document, ni que le fichier ne pourra pas être conservé. "
            . "Les rubriques que TU peux servir toi-même sont ÉNUMÉRÉES dans le paramètre « cible.entite » "
            . "d'attacher_fichier — n'en invente aucune autre, et ne récite pas de liste de mémoire. Pour une "
            . "fiche absente de cette énumération, dis à l'utilisateur de déposer le fichier depuis le widget "
            . "« Documents » de sa fiche : c'est une limite de CE QUE TU PEUX ÉCRIRE, jamais de ce que la "
            . "plateforme sait conserver. "
            . "LE CLASSEUR NE TE CONCERNE PAS : tout document rattaché à un client — directement ou par sa "
            . "piste, sa cotation, sa police — est rangé AUTOMATIQUEMENT par le serveur dans le classeur de ce "
            . "client, créé au besoin. Ne demande JAMAIS à l'utilisateur dans quel classeur ranger un fichier, "
            . "ne mets JAMAIS « classeur » dans un plan, et n'annonce pas que la pièce restera « non classée ». "
