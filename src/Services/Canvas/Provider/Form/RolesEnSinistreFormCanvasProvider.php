    ...
    public function getCanvas(object $object, ?int $idEntreprise): array
    {
        ...
        $parametres = [
            ...
            "description_creation" => [
                "Un rôle ouvre une porte : sans lui, ce collaborateur ne voit rien du module Sinistre, car l'espace de travail est fermé par défaut.",
                "Vous décidez ici ce qu'il peut consulter et modifier sur les notifications de sinistre, les pièces, les règlements et les types de pièces.",
                "Un dossier de sinistre contient des informations personnelles sur l'assuré. N'accordez que le nécessaire.",
            ],
            ...
            "field_icons" => [
                "accessTypePiece"    => "modele-piece",
                "accessNotification" => "action:alert",
                "accessReglement"    => "paiement",
            ],
        ];
