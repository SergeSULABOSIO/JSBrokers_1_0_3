...
class PartenaireEntityCanvasProvider implements EntityCanvasProviderInterface
{
    ...
    private function getSpecificIndicators(): array
    {
        ...
        return [
            ...
            ["group" => "Facturation & Paiements", "code" => "montant_du", "intitule" => "Commission à facturer", "type" => "Calcul", "format" => "Monetaire", "unite" => $monnaie, "description" => "Montant total TTC facturé."],
            ...
            ["group" => "Partage Partenaire", "code" => "retroCommissionExigible", "intitule" => "Rétro-commission Exigible", "type" => "Calcul", "format" => "Monetaire", "unite" => $monnaie, "description" => "Part du solde à payer DÈS MAINTENANT : celle dont la commission partageable correspondante est déjà encaissée par le cabinet."],
