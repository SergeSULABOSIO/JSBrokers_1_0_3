...
class TrancheEntityCanvasProvider implements EntityCanvasProviderInterface
{
    ...
    private function getSpecificIndicators(): array
    {
        ...
        return [
            ...
            ["group" => "Suivi des Encaissements", "code" => "statutPaiement", "intitule" => "Statut Paiement", "type" => "Calcul", "format" => "Texte", "description" => "État du règlement combiné : prime encaissée ET commission collectée."],
            ["group" => "Suivi des Encaissements", "code" => "urgenceRecouvrement", "intitule" => "Urgence Recouvrement", "type" => "Calcul", "format" => "Texte", "description" => "Niveau d'urgence de la collecte (retard avéré, échéance imminente, proche, lointaine ou réglée)."],
            ["group" => "Suivi des Encaissements", "code" => "retroCommissionExigible", "intitule" => "Rétro Exigible", "type" => "Calcul", "format" => "Monetaire", "unite" => $monnaie, "description" => "Rétrocommission à payer au partenaire dès maintenant : solde dû dont la commission partageable correspondante est déjà encaissée."],
            ["group" => "Suivi des Encaissements", "code" => "primeDeclareePayee", "intitule" => "Prime Signalée Payée", "type" => "Calcul", "format" => "Monetaire", "unite" => $monnaie, "description" => "Cumul des paiements de prime signalés (encaissés par l'assureur — n'impacte jamais la trésorerie du courtier)."],
            ["group" => "Suivi des Encaissements", "code" => "commissionExigible", "intitule" => "Commission Exigible", "type" => "Calcul", "format" => "Monetaire", "unite" => $monnaie, "description" => "Commission à collecter dès maintenant auprès de l'assureur : la prime est payée par l'assuré (facturée ou signalée) et la commission n'est pas encore encaissée."],
