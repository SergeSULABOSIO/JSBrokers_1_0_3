...
class AvenantEntityCanvasProvider implements EntityCanvasProviderInterface
{
    ...
    private function getSpecificIndicators(): array
    {
        ...
        return [
            ...
            ["group" => "Statut & Suivi", "code" => "origineDeLaPolice", "intitule" => "Origine de la police", "type" => "Calcul", "format" => "Texte", "description" => "Le sens INVERSE de « Suite de la police » : la police que celle-ci REMPLACE (numéro, référence, période de couverture) et l'opportunité dérivée qui a produit le mouvement. Vide pour une affaire nouvelle. C'est ce qui permet de relier un renouvellement à la police renouvelée sans avoir à la retrouver soi-même."],
            ["group" => "Statut & Suivi", "code" => "nonRenouvelableDetail", "intitule" => "Non renouvelable", "type" => "Calcul", "format" => "Texte", "description" => "Décision du courtier de ne PAS renouveler cette police, avec sa date, son auteur et son motif. La police sort du suivi des échéances, mais la couverture court jusqu'à son terme et tout ce qui reste dû continue d'être réclamé. Note interne : jamais transmise au client."],
            ["group" => "Statut & Suivi", "code" => "nonRenouvelableHistorique", "intitule" => "Marquage levé", "type" => "Calcul", "format" => "Texte", "description" => "Rappel d'une décision de non-renouvellement qui a été RETIRÉE : la police est redevenue renouvelable et a réintégré le suivi des échéances. Conservé pour expliquer son absence passée du pipeline."],
            ...
            ["group" => "Facturation & Paiements", "code" => "montant_du", "intitule" => "Commission à facturer", "type" => "Calcul", "format" => "Monetaire", "unite" => $monnaie, "description" => "Commission totale TTC à facturer au titre de cette police. Correspond au Revenu Brut TTC calculé sur la prime."],
