    ...
    public function getCanvas(): array
    {
        return [
            ...
            "liste" => array_merge([
                ...
                ["code" => "montantCommissionHT", "intitule" => "Montant HT", "type" => "Nombre", "format" => "Monetaire", "unite" => $this->serviceMonnaies->getCodeMonnaieAffichage()],
                ["code" => "montantTaxe", "intitule" => "Montant Taxe", "type" => "Nombre", "format" => "Monetaire", "unite" => $this->serviceMonnaies->getCodeMonnaieAffichage()],
