...
class ArticleEntityCanvasProvider implements EntityCanvasProviderInterface
{
    ...
    private function getSpecificIndicators(): array
    {
        ...
        return [
            ...
            ["group" => "Finances", "code" => "montantArticleHT", "intitule" => "Montant HT", "type" => "Calcul", "format" => "Monetaire", "unite" => $monnaie, "description" => "Le montant Hors Taxe de cette ligne de facturation."],
            ["group" => "Finances", "code" => "valeurUnitaireHT", "intitule" => "Valeur Unitaire HT", "type" => "Calcul", "format" => "Monetaire", "unite" => $monnaie, "description" => "La valeur unitaire Hors Taxe de l'article (Montant HT / Quantité)."],
